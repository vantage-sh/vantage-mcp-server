      ...
      <body>
        <div class="container">
          <div class="card">
            ...
            <p class="description">
              With the Vantage MCP (Model Context Protocol), you can use natural
              language to explore your organization’s cloud costs via MCP clients,
              like Claude, Cursor, Goose, and others.
            </p>

            <p class="description">
              <a href="${docsUrl}" class="btn btn-approve"
                >Learn more about Vantage MCP</a
              >
            </p>
          </div>
        </div>
