...
- Adjustment rules require percentage.
- Charge and Credit rules require service, category, sub_category, and amount.
...
export default registerTool({
  ...
  args: {
    ...
    start_date: dateValidator("The start date for the billing rule in ISO 8601 format (YYYY-MM-DD).").optional(),
    ...
    charge_type: z.string().optional().describe("The charge type. Required for Exclusion rules."),
    percentage: z.number().optional().describe("The percentage adjustment. Required for Adjustment rules (e.g. 75.0)."),
    service: z.string().optional().describe("The service. Required for Charge and Credit rules."),
    category: z.string().optional().describe("The category. Required for Charge and Credit rules."),
    sub_category: z.string().optional().describe("The sub-category. Required for Charge and Credit rules."),
    amount: z.number().optional().describe("The amount. Required for Charge and Credit rules (e.g. 300)."),
    sql_query: z.string().optional().describe("The SQL query. Required for Custom rules."),
  },
